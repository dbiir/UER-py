...
from uer.targets.pegasus_target import PegasusTarget
...
str2target = {"bert": BertTarget, "mlm": MlmTarget, "lm": LmTarget,
              ...
              "t5": T5Target, "pegasus": PegasusTarget, "cls": ClsTarget, "prefixlm": PrefixlmTarget}

__all__ = ["BertTarget", "MlmTarget", "LmTarget", "BilmTarget", "AlbertTarget",
           "Seq2seqTarget", "T5Target", "PegasusTarget", "ClsTarget", "PrefixlmTarget", "str2target"]
