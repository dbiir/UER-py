def model_opts(parser):
    parser.add_argument("--embedding", choices=["word", "word_pos", "word_pos_seg", "word_sinusoidalpos", "dual", "word_pos_seg_pinyin_bushou"],
                        default="word_pos_seg", help="Emebdding type.")
