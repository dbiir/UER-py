def model_opts(parser):
    parser.add_argument("--embedding", choices=["patch_pos", "patch", "vil", "bistream", "word", "word_pos", "word_pos_seg", "word_sinusoidalpos"], default="word_pos_seg",
                        help="Emebdding type.")
    ...
    parser.add_argument("--encoder", choices=["transformer", "bistream", "rnn", "lstm", "gru",
                                              "birnn", "bilstm", "bigru",
                                              "gatedcnn"],
