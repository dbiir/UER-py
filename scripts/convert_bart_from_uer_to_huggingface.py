...
def convert_encoder_decoder_transformer_from_uer_to_huggingface(input_model, output_model, layers_num):
    for i in range(layers_num):
        ...
        output_model["model.decoder.layers." + str(i) + ".self_attn.q_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.linear_layers.0.weight"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.q_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.linear_layers.0.bias"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.k_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.linear_layers.1.weight"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.k_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.linear_layers.1.bias"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.v_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.linear_layers.2.weight"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.v_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.linear_layers.2.bias"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.out_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.final_linear.weight"]
        output_model["model.decoder.layers." + str(i) + ".self_attn.out_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".self_attn.final_linear.bias"]
        output_model["model.decoder.layers." + str(i) + ".self_attn_layer_norm.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_1.gamma"]
        output_model["model.decoder.layers." + str(i) + ".self_attn_layer_norm.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_1.beta"]

        output_model["model.decoder.layers." + str(i) + ".encoder_attn.q_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.linear_layers.0.weight"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.q_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.linear_layers.0.bias"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.k_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.linear_layers.1.weight"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.k_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.linear_layers.1.bias"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.v_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.linear_layers.2.weight"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.v_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.linear_layers.2.bias"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.out_proj.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.final_linear.weight"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn.out_proj.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".context_attn.final_linear.bias"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn_layer_norm.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_2.gamma"]
        output_model["model.decoder.layers." + str(i) + ".encoder_attn_layer_norm.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_2.beta"]

        output_model["model.decoder.layers." + str(i) + ".fc1.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_1.weight"]
        output_model["model.decoder.layers." + str(i) + ".fc1.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_1.bias"]
        output_model["model.decoder.layers." + str(i) + ".fc2.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_2.weight"]
        output_model["model.decoder.layers." + str(i) + ".fc2.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_2.bias"]
        output_model["model.decoder.layers." + str(i) + ".final_layer_norm.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_3.gamma"]
        output_model["model.decoder.layers." + str(i) + ".final_layer_norm.bias"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_3.beta"]
