...
def main():
    ...
    # Path options.
    parser.add_argument("--input_model_path", type=str, default='models/albert_base_chinese.ckpt',
                        help="Path of the input model.")
    parser.add_argument("--output_model_path", type=str, default='uer.bin',
                        help="Path of the output model.")

    args = parser.parse_args()

    # print("Converting TensorFlow checkpoint from {}".format(args.input_model_path))

    # Load weights from TensorFlow checkpoint.
#    init_vars = tf.train.list_variables(args.input_model_path)
#    names = []
#    arrays = []
#    for name, shape in init_vars:
        # print("Loading TF weight {} with shape {}".format(name, shape))
#        array = tf.train.load_variable(args.input_model_path, name)
#        names.append(name)
#        arrays.append(array)
...
#    for key, array in zip(names, arrays):
#        torch_tensor = torch.Tensor(array)
    for key in var_to_shape_map:
        ...
        if key == "bert/embeddings/token_type_embeddings":
            #torch_tensor = torch.cat((torch.Tensor([[0] * torch_tensor.size()[1]]), torch_tensor), dim=0)
    ...
    output_model["encoder.transformer.self_attn.linear_layers.0.weight"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/self/query/kernel"]
    output_model["encoder.transformer.self_attn.linear_layers.0.bias"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/self/query/bias"]
    output_model["encoder.transformer.self_attn.linear_layers.1.weight"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/self/key/kernel"]
    output_model["encoder.transformer.self_attn.linear_layers.1.bias"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/self/key/bias"]
    output_model["encoder.transformer.self_attn.linear_layers.2.weight"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/self/value/kernel"]
    output_model["encoder.transformer.self_attn.linear_layers.2.bias"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/self/value/bias"]
    output_model["encoder.transformer.self_attn.final_linear.weight"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/output/dense/kernel"]
    output_model["encoder.transformer.self_attn.final_linear.bias"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/attention_1/output/dense/bias"]
    output_model["encoder.transformer.layer_norm_1.gamma"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/LayerNorm/gamma"]
    output_model["encoder.transformer.layer_norm_1.beta"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/LayerNorm/beta"]
    output_model["encoder.transformer.feed_forward.linear_1.weight"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/ffn_1/intermediate/dense/kernel"]
    output_model["encoder.transformer.feed_forward.linear_1.bias"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/ffn_1/intermediate/dense/bias"]
    output_model["encoder.transformer.feed_forward.linear_2.weight"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/ffn_1/intermediate/output/dense/kernel"]
    output_model["encoder.transformer.feed_forward.linear_2.bias"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/ffn_1/intermediate/output/dense/bias"]
    output_model["encoder.transformer.layer_norm_2.gamma"] = input_model[
        "bert/encoder/transformer/group_0/inner_group_0/LayerNorm_1/gamma"]
    output_model["encoder.transformer.layer_norm_2.beta"] = input_model[
