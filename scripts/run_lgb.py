...
import json
import argparse
from run_bayesopt import read_labels
...
def main():
    ...
    params = {
        ...
        'num_class': 6,  
        'metric': 'multi_error',
        'feature_fraction':0.3729,
        'lambda_l1':  9.874,
        'lambda_l2': 0.1256 ,
        'learning_rate': 0.04013,
        'max_depth': 186,
        'min_data_in_leaf': 8,
        'min_gain_to_split': 0.7786,
        'min_sum_hessian_in_leaf': 8.761,
        'num_leaves': 89
    }
    ...
    model = lgb.train(params,lgb_train,num_boost_round=120,valid_sets=lgb_eval, verbose_eval=40)
