...
output_model["decoder.block.0.layer.0.SelfAttention.relative_attention_bias.weight"] = input_model["target.decoder.relative_pos_emb.relative_attention_bias.weight"]
...
for i in range(args.layers_num):
    ...
    output_model["encoder.block." + str(i) + ".layer.0.layer_norm.weight"] = input_model["encoder.transformer." + str(i) + ".layer_norm_1.gamma"]
    ...
    output_model["encoder.block." + str(i) + ".layer.1.layer_norm.weight"] = input_model["encoder.transformer." + str(i) + ".layer_norm_2.gamma"]
    ...
    output_model["decoder.block." + str(i) + ".layer.0.layer_norm.weight"] = input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_1.gamma"]
    ...
    output_model["decoder.block." + str(i) + ".layer.1.layer_norm.weight"] = input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_2.gamma"]
    ...
    output_model["decoder.block." + str(i) + ".layer.2.layer_norm.weight"] = input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_3.gamma"]

output_model["encoder.final_layer_norm.weight"] = input_model["encoder.layer_norm.gamma"]
output_model["decoder.final_layer_norm.weight"] = input_model["target.decoder.layer_norm.gamma"]
