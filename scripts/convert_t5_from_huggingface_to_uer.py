...
output_model["target.embedding.word_embedding.weight"] = \
...
output_model["target.decoder.self_pos_emb.relative_attention_bias.weight"] = \
...
for i in range(args.layers_num):
    ...
    output_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_1.weight"] = \
    ...
    output_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_2.weight"] = \
        input_model["decoder.block." + str(i) + ".layer.1.layer_norm.weight"]

    if args.type == "t5-v1_1":
        output_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_gate.weight"] = \
        ...
        output_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_2.weight"] = \
            input_model["decoder.block." + str(i) + ".layer.2.DenseReluDense.wo.weight"]
    output_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_3.weight"] = \
...
output_model["target.decoder.layer_norm.weight"] = \
