...
output_model["decoder.block.0.layer.0.SelfAttention.relative_attention_bias.weight"] = \
    input_model["target.decoder.self_pos_emb.relative_attention_bias.weight"]
...
for i in range(args.layers_num):
    ...
    output_model["decoder.block." + str(i) + ".layer.0.layer_norm.weight"] = \
        input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_1.weight"]
    ...
    output_model["decoder.block." + str(i) + ".layer.1.layer_norm.weight"] = \
        input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_2.weight"]

    if args.type == "t5-v1_1":
        output_model["decoder.block." + str(i) + ".layer.2.DenseReluDense.wi_0.weight"] = \
            input_model["target.decoder.transformer_decoder." + str(i) + ".feed_forward.linear_gate.weight"]
    ...
    output_model["decoder.block." + str(i) + ".layer.2.layer_norm.weight"] = \
        input_model["target.decoder.transformer_decoder." + str(i) + ".layer_norm_3.weight"]
...
output_model["decoder.final_layer_norm.weight"] = \
    input_model["target.decoder.layer_norm.weight"]
