...
def main():
    ...
    parser.add_argument("--target", choices=["bert", "lm", "mlm", "bilm", "albert", "seq2seq", "t5", "cls", "prefixlm", "pegasus"], default="bert",
    ...
    parser.add_argument("--sentence_select_strategy", choices=["lead", "random", "rouge"], default="lead",
